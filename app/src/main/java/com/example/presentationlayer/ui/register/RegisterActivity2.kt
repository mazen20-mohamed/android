...
import com.example.presentationlayer.model.UserData
...
//            autoCompleteTextView.showDropdown(adapter)
    ...
    fun register(gender:String , activationRate:Double){
        ...
        FirebaseMessaging.getInstance().token.addOnCompleteListener(OnCompleteListener { task ->
            ...
            var user: UserData = UserData(name.toString(),email.toString(),password.toString(),weight.text.toString().toDouble(),height.text.toString().toInt(),age.text.toString().toInt(),activationRate,gender,token)
